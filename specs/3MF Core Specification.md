...
- [ 3D Manufacturing Format](#-3d-manufacturing-format)
	- [Core Specification \& Reference Guide](#core-specification--reference-guide)
...
- [Chapter 2. Parts and Relationships](#chapter-2-parts-and-relationships)
	- [2.1. 3D Payload](#21-3d-payload)
		- [2.1.1. 3D Parts and Payload Relationships](#211-3d-parts-and-payload-relationships)
		- [2.1.2. 3D Model Part](#212-3d-model-part)
		- [2.1.3. Package Thumbnail and Object Thumbnail Part](#213-package-thumbnail-and-object-thumbnail-part)
		- [2.1.4. PrintTicket Part](#214-printticket-part)
		- [2.1.5. MustPreserve Relationship](#215-mustpreserve-relationship)
	- [2.2. Naming Conventions](#22-naming-conventions)
		- [2.2.1 Document Naming Recommendation](#221-document-naming-recommendation)
		- [2.2.2 Reserved Naming Conventions](#222-reserved-naming-conventions)
		- [2.2.3 Part Naming Recommendations](#223-part-naming-recommendations)
	- [2.3. 3MF Document Markup](#23-3mf-document-markup)
		- [2.3.1. Support for Versioning and Extensibility](#231-support-for-versioning-and-extensibility)
		- [2.3.2. XML Usage](#232-xml-usage)
		- [2.3.3. Markup Model](#233-markup-model)
			- [2.3.3.1. XML Namespaces](#2331-xml-namespaces)
		- [2.3.4. Whitespace](#234-whitespace)
		- [2.3.5. Language](#235-language)
- [Chapter 3. 3D Models](#chapter-3-3d-models)
	...
	- [3.4. Model](#34-model)
		...
		- [3.4.1. Metadata](#341-metadata)
				- [Attributes](#attributes-1)
		- [3.4.2. Resources](#342-resources)
		- [3.4.3. Build Instructions](#343-build-instructions)
			- [3.4.3.1. Item Element](#3431-item-element)
...
- [Chapter 4. Object Resources](#chapter-4-object-resources)
	...
	- [4.1. Meshes](#41-meshes)
		- [4.1.1. Fill Rule](#411-fill-rule)
		- [4.1.2. Overlapping order](#412-overlapping-order)
		- [4.1.3. Vertices](#413-vertices)
			- [4.1.3.1. Vertex](#4131-vertex)
				- [Attributes](#attributes-4)
		- [4.1.4. Triangles](#414-triangles)
			- [4.1.4.1. Triangle](#4141-triangle)
				- [Attributes](#attributes-5)
		- [4.1.5. Triangle Sets](#415-triangle-sets)
			- [4.1.5.1 Triangle Set Elements](#4151-triangle-set-elements)
			- [4.1.5.2 Triangle Set References](#4152-triangle-set-references)
			- [4.1.5.3 Triangle Set Reference Ranges](#4153-triangle-set-reference-ranges)
...
- [Chapter 5. Material Resources](#chapter-5-material-resources)
	...
	- [5.1. Base Material](#51-base-material)
		...
		- [5.1.1. sRGB Color](#511-srgb-color)
- [Chapter 6. 3MF Document Package Features](#chapter-6-3mf-document-package-features)
	- [6.1. Package Thumbnail and Object Thumbnail](#61-package-thumbnail-and-object-thumbnail)
		- [6.1.1. JPEG Images](#611-jpeg-images)
		- [6.1.2. PNG Images](#612-png-images)
	- [6.2. Core Properties](#62-core-properties)
	- [6.3. Digital Signatures](#63-digital-signatures)
		- [6.3.1. Normalization](#631-normalization)
...
- [Part II. Appendices](#part-ii-appendices)
	...
	- [Appendix B.1. 3MF XSD Schema](#appendix-b1-3mf-xsd-schema)
		- [B.1.1 Core specification schema](#b11-core-specification-schema)
		- [B.1.2 Triangle Set extension schema](#b12-triangle-set-extension-schema)
